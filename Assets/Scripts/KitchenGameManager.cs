...
public class KitchenGameManager : NetworkBehaviour {
    ...
    private void SceneManager_OnLoadEventCompleted(string sceneName, LoadSceneMode loadSceneModecenemode, List<ulong> clientsCompleted, List<ulong> clientsTimedOut) {
